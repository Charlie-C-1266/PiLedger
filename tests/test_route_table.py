...
EXPECTED_ROUTES = {
    ...
    ("/api/budget", "GET"),
    ("/api/budget/groups", "POST"),
    ("/api/budget/groups/{gid}", "DELETE"),
    ("/api/budget/groups/{gid}", "PUT"),
    ("/api/budget/envelopes", "POST"),
    ("/api/budget/envelopes/{eid}", "DELETE"),
    ("/api/budget/envelopes/{eid}", "PUT"),
    ("/api/budget/income", "POST"),
    ("/api/budget/income/{iid}", "DELETE"),
    ("/api/budget/income/{iid}", "PUT"),
    ("/api/categories", "GET"),
    ("/api/categories", "POST"),
