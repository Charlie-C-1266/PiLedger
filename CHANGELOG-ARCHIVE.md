...
Released versions prior to the current cycle. The live changelog — the current `[Unreleased]`
work and the most recent release — lives in [CHANGELOG.md](CHANGELOG.md).
