...
export function BudgetIcon(props: React.SVGProps<SVGSVGElement>) {
  return <svg {...s} {...props}><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3.5 2" /></svg>;
}
...
export function TransferIcon(props: React.SVGProps<SVGSVGElement>) {
  return <svg {...s} {...props}><polyline points="17 1 21 5 17 9" /><path d="M3 11V9a4 4 0 0 1 4-4h14" /><polyline points="7 23 3 19 7 15" /><path d="M21 13v2a4 4 0 0 1-4 4H3" /></svg>;
}
...
export function RepeatIcon(props: React.SVGProps<SVGSVGElement>) {
  return <svg {...s} {...props}><polyline points="17 1 21 5 17 9" /><path d="M3 11V9a4 4 0 0 1 4-4h14" /><polyline points="7 23 3 19 7 15" /><path d="M21 13v2a4 4 0 0 1-4 4H3" /><circle cx="12" cy="12" r="2.2" fill="currentColor" stroke="none" /></svg>;
}
